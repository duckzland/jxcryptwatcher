...
func processFlashingText(tag string, txt AnimatableText, interval time.Duration, visibleColor color.Color, flashes int, ctx context.Context, cancel context.CancelFunc) {
	...
	go func(tag string, txt AnimatableText, interval time.Duration, visibleColor color.Color, flashes int, ctx context.Context, cancel context.CancelFunc) {
	...
	}(tag, txt, interval, visibleColor, flashes, ctx, cancel)
}
